...
import { ChatIcon, HelpToolIcon, LearnIcon, SettingsIcon } from './icons';
            ...
            {navItems.map((item) => {
                ...
                return (
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 p-2 rounded-xl min-w-[70px] transition-all duration-200 transform active:scale-95 ${activeTab === item.id ? 'text-purple-600 bg-purple-100' : 'text-gray-500 hover:bg-purple-50 active:bg-purple-100'} ${isChatAndAnimating ? 'animate-tab-pop' : ''}`}
                    >
